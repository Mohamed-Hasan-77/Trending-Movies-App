  ...
  const settings = {
    customPaging: function (i) {
      return (
        <a>
          <img
            src={`${baseUrl}${movieData[i].poster_path}`}
            alt="movie Poster"
          />
        </a>
      );
                ...
                <div className=" top-0 left-0 absolute w-full h-full bg-overlayWhite dark:bg-overlayDark py-14  z-10 backdrop-blur-md   flex justify-center items-center shadow:md ">
                  <div className="wrapper flex justify-center items-center md:items-start flex-col md:flex-row space-x-5 h-3/4 px-2 md:px-4 lg:px-9 mt-10   ">
                    ...
                    <div className="description text-white flex items-start flex-col w-3/4 md:w-1/2 h-full">
                      <h2 className="font-bold text-3xl lg:text-4xl mt-4 md:mt-0 ">
                        {" "}
                        {movie.title}{" "}
                      </h2>
                      ...
                      <h3 className="text-base md:text-1xl lg:text-1xl mt-3">
                        {" "}
                        ...
                        <i className="fa-brands fa-imdb text-yellow-300 ml-2 text-2xl"></i>{" "}
                      </h3>
                      <p className=" hidden md:block text-start text-sm lg:text-1xl md:leading-9 mt-3 ">
                        {" "}
                        {movie.overview}
                      </p>
                      <p className=" block md:hidden  text-start text-sm lg:text-1xl lg:leading-9 mt-3">
                        {" "}
                        {movie.overview
                          .split(" ")
                          .slice(0, 10)
                      ...
                      <div className="space-x-5 mt-3 md:mt-9 flex justify-around items-center w-full">
                        <button className="text-xs md:text-base bg-themeColor_purple text-white w-1/2 px-5 py-2 outline-none hover:bg-gray-600 transition-colors duration-150  rounded-full">
                          {" "}
                        ...
                        <button className=" text-xs md:text-base bg-themeColor_red text-white w-1/2 px-5 py-2 outline-none hover:bg-gray-600 transition-colors duration-150  rounded-full ">
                          {" "}
                          <Link to={`/moviePage/${movie.id}`}>
                            {" "}
                            More Details{" "}
