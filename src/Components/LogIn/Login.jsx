 ...
 // console.log(getUserData());
  // user data
    ...
    <div class="py-20 container pt-32 ">
        <div class="flex bg-white rounded-lg shadow-xl overflow-hidden mx-auto max-w-sm lg:max-w-4xl  dark:bg-gray-900 dark:text-gray-100 ">
            <div class="hidden lg:block lg:w-1/2 bg-cover"  > 
                <img className='w-full h-full object-cover' src="https://images.unsplash.com/photo-1546514714-df0ccc50d7bf?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=667&q=80"  alt="" />
            </div>
            <div class="w-full p-8 lg:w-1/2">
                <h2 class="text-2xl font-semibold text-gray-700 dark:text-gray-100 text-center "> Trending Movies </h2>
                ...
                <a href="#" class="flex items-center justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100 ">
                    ...
                    <h1 class="px-4 py-3 w-5/6 text-center text-gray-500 font-bold ">Sign in with Google</h1>
                </a>
