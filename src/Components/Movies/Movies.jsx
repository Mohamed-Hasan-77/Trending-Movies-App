...
export default function Movies() {
  ...
  async function getMovies() {
    ...
    try{
      let {data} = await axios.get('https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=en-US&page=1&sort_by=popularity.desc',
      {params: {
  ...
  return <>
      <div className="container mx-auto py-24">
            ...
            <ul class="flex space-x-2 my-7 justify-center">
                <li>
                  <button onClick={() => {paginationDwon()}}  class="flex items-center justify-center mr-1 w-9 h-9  text-white  transition-colors duration-150 rounded-full focus:shadow-outline dark:text-black bg-indigo-300 hover:bg-indigo-600">
...
return <div key={idx} className=" w-1/2 md:w-1/5 lg:w-1/6 p-2  ">
